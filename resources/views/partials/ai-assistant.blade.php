{{-- ─── Floating AsistenAI (Chatbot AI — Fase 2) ──────────────────────────────
    ...
    <div x-show="open" x-cloak
        ...
        <div class="flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-primary to-primary-700 text-white shrink-0">
            ...
            <div class="min-w-0 flex-1">
                <p class="font-semibold leading-tight">AsistenAI</p>
        ...
        <template x-if="view === 'chat'">
            <div class="flex flex-1 flex-col min-h-0">
                ...
                <div x-ref="scroll" class="flex-1 overflow-y-auto px-4 py-4 space-y-3 bg-slate-50 dark:bg-slate-800/40">
                    ...
                    <template x-if="messages.length === 0">
                        <div class="text-center py-6">
                            <p class="text-slate-600 dark:text-slate-300 text-sm">Halo! 👋 Aku <b>AsistenAI</b>.<br>Tanya apa saja soal sekolah atau cara pakai aplikasi.</p>
                ...
                <div class="border-t border-slate-200 dark:border-slate-700 p-3 bg-white dark:bg-slate-900 shrink-0">
                    ...
                    <p class="mt-1.5 text-[10px] text-slate-400 text-center">AsistenAI bisa keliru. Jangan bagikan data sensitif.</p>
                </div>
            </div>
        </template>
