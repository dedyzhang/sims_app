    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div class="card p-6 flex flex-col">
            <div class="flex items-center gap-3 mb-4">
                <span class="grid place-items-center w-12 h-12 rounded-2xl bg-slate-500/10 text-slate-700 dark:text-slate-200 flex-shrink-0">
                    <i data-lucide="smartphone" class="w-6 h-6"></i>
                </span>
                <div class="min-w-0">
                    <p class="font-bold text-slate-800 dark:text-slate-100">Aplikasi iPhone / iPad</p>
                    <p class="text-xs text-slate-400">Pasang lewat Safari (PWA), tanpa App Store</p>
                </div>
            </div>
            <a href="{{ route('guest.app.ios') }}"
               class="btn-primary mt-auto px-5 py-2.5 rounded-xl text-sm font-bold flex items-center justify-center gap-2">
                <i data-lucide="plus" class="w-4 h-4"></i> Cara Pasang
            </a>
        </div>
