    ...
    return {
        ...
        encodeForm(e) {
            ...
            ['teks_soal', 'penjelasan', 'kunci_esai'].forEach(name => {
                ...
                if (el) el.value = encodeStr(el.value);
            });
            
            form.querySelectorAll('[name^="opsi["][name$="[teks]"]').forEach(el => el.value = encodeStr(el.value));
            form.querySelectorAll('[name^="pasangan["]').forEach(el => el.value = encodeStr(el.value));
