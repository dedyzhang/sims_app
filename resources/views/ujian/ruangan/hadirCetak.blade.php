...
<head>
    <meta charset="utf-8">
    <title>Daftar Hadir — {{ $ruangan->nama }} — {{ \App\Support\TanggalIndo::panjang(\Carbon\Carbon::parse($tanggal)) }}</title>
    <style>
        * { box-sizing: border-box; }
        body { font-family: "Times New Roman", Georgia, serif; color: #000; margin: 0; font-size: 12.5px; }

        {{-- dompdf TIDAK menghormati box-sizing:border-box utk width — lihat catatan detail
             di beritaAcaraCetak.blade.php. width = lebar KONTEN saja (170mm), bukan 210mm. --}}
        .page { width: 170mm; padding: 18mm 20mm; background: #fff; }

        {{-- dompdf flexbox tak bisa diandalkan utk row 3-kolom (logo/ident/logo) — lihat
             catatan detail di beritaAcaraCetak.blade.php. Pakai table sbg gantinya. --}}
