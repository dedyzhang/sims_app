...
class GamePracticeSession extends Model
{
    use HasUuids;

    protected $table = 'game_practice_sessions';
    protected $primaryKey = 'uuid';
    public $incrementing = false;
    protected $keyType = 'string';

    protected $fillable = [
        'quiz_id', 'classroom_id', 'hosted_by', 'join_token', 'status',
    ...
    {
        return $this->hasMany(GamePracticeParticipant::class, 'session_id', 'uuid');
    }
